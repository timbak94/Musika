...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__songs_hash_map_js__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__score_board__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__overlay__ = __webpack_require__(9);
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const game = new __WEBPACK_IMPORTED_MODULE_0__game__["a" /* default */](track, ctx, 150, __WEBPACK_IMPORTED_MODULE_2__songs_ramune_beatmap_js__["a" /* BEATMAP */]);
  offset.addEventListener("change", () => {
    let map = [];
    for (var i = 0; i < parseInt(offset.value); i++) {
      map = map.concat(["", "", "", ""]);
    }
    game.beatMap = map.concat(__WEBPACK_IMPORTED_MODULE_2__songs_ramune_beatmap_js__["a" /* BEATMAP */]);
  });

...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__track__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__songs_pixel_beatmap_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__songs_ramune_beatmap_js__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__score_board__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__overlay__ = __webpack_require__(10);
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  new __WEBPACK_IMPORTED_MODULE_5__overlay__["a" /* default */](ctx2);
  const offsetValue = document.getElementById("offset-value");
  const play = document.getElementById("play");
  const pixelContinue = document.getElementById("continue");
  const menu = document.getElementsByClassName("menu")[0];
  const board = new __WEBPACK_IMPORTED_MODULE_4__score_board__["a" /* default */]();
  const game = new __WEBPACK_IMPORTED_MODULE_0__game__["a" /* default */](new __WEBPACK_IMPORTED_MODULE_1__track__["a" /* default */](board), ctx, 150, __WEBPACK_IMPORTED_MODULE_2__songs_pixel_beatmap_js__["a" /* BEATMAP */], 1);
  const ramune = document.getElementById("ramune");
  const pixel = document.getElementById("pixel-galaxy");
  let buffer = [];
  let chosenBeat = __WEBPACK_IMPORTED_MODULE_2__songs_pixel_beatmap_js__["a" /* BEATMAP */];
  ...
  ramune.addEventListener("click", ()=>{
    ...
    game.select = 2;
    game.bpm = 75;
    game.beatMap = __WEBPACK_IMPORTED_MODULE_3__songs_ramune_beatmap_js__["a" /* BEATMAP2 */];
    chosenBeat = __WEBPACK_IMPORTED_MODULE_3__songs_ramune_beatmap_js__["a" /* BEATMAP2 */];
  });
  pixel.addEventListener("click", ()=>{
    ...
    game.select = 1;
    game.bpm = 150;
    game.beatMap = __WEBPACK_IMPORTED_MODULE_2__songs_pixel_beatmap_js__["a" /* BEATMAP */];
    chosenBeat = __WEBPACK_IMPORTED_MODULE_2__songs_pixel_beatmap_js__["a" /* BEATMAP */];
  });
...
class Game {
  constructor(track, ctx, bpm, beatMap, select) {
    ...
    this.select = select;
    this.song = new __WEBPACK_IMPORTED_MODULE_0_howler__["Howl"]({
    ...
    this.song2 = new __WEBPACK_IMPORTED_MODULE_0_howler__["Howl"]({
    ...
    this.victory = new __WEBPACK_IMPORTED_MODULE_0_howler__["Howl"]({
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__note_js__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__hitbox_js__ = __webpack_require__(6);
...
class Track {
  ...
  addNote(key) {
    switch(key) {
      case "s":
        this.note1.push(new __WEBPACK_IMPORTED_MODULE_0__note_js__["a" /* default */]({pos: [20,0], value: 1, game: this}));
        break;
      case "d":
        this.note2.push(new __WEBPACK_IMPORTED_MODULE_0__note_js__["a" /* default */]({pos: [140,0], value: 2, game: this}));
        break;
      case "j":
        this.note3.push(new __WEBPACK_IMPORTED_MODULE_0__note_js__["a" /* default */]({pos: [260,0], value: 3, game: this}));
        break;
      case "k":
        this.note4.push(new __WEBPACK_IMPORTED_MODULE_0__note_js__["a" /* default */]({pos: [380,0], value: 4, game: this}));
        break;
    }
  }

  addHitBox(ctx, val) {
    let box = new __WEBPACK_IMPORTED_MODULE_1__hitbox_js__["a" /* default */]({value: val, game: this});
  ...
  draw(ctx) {
    ...
    this.allItems().forEach((obj) => {
      if (obj instanceof __WEBPACK_IMPORTED_MODULE_0__note_js__["a" /* default */]) {
        obj.draw(ctx);
      } else if (obj instanceof __WEBPACK_IMPORTED_MODULE_1__hitbox_js__["a" /* default */]) {
        obj.draw(ctx);
      }
    });
  }
...
/* harmony default export */ __webpack_exports__["a"] = (HitBox);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = BEATMAP;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = BEATMAP2;
...
class ScoreBoard {
  constructor() {
    ...
    this.song = "pixel";
    this.sugoi = new __WEBPACK_IMPORTED_MODULE_0_howler__["Howl"]({

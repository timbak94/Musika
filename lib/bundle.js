...
document.addEventListener("DOMContentLoaded", () => {
  ...
  new __WEBPACK_IMPORTED_MODULE_0__game__["a" /* default */](track, ctx, 150, __WEBPACK_IMPORTED_MODULE_2__songs_ramune_beatmap_js__["a" /* BEATMAP */]).start();
});
...
class Game {
  ...
  noteFeed(array) {
    console.log(this.round(this.song.seek(), 4));
    if (array.length > 0) {
...
class ScoreBoard {
  ...
  update() {
    ...
    board[0].innerText = "SCORE: " + this.score.toString();

    let combo = document.getElementsByClassName("combo-board");
    combo[0].innerText = "COMBO: " + this.combo.toString();
  }
}

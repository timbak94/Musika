...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__songs_ramune_beatmap_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__score_board__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__overlay__ = __webpack_require__(9);
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const board = new __WEBPACK_IMPORTED_MODULE_3__score_board__["a" /* default */]();
  const track = new __WEBPACK_IMPORTED_MODULE_1__track__["a" /* default */](board);
  new __WEBPACK_IMPORTED_MODULE_4__overlay__["a" /* default */](ctx2);
  new __WEBPACK_IMPORTED_MODULE_0__game__["a" /* default */](track, ctx, 120, __WEBPACK_IMPORTED_MODULE_2__songs_ramune_beatmap_js__["a" /* BEATMAP */]).start();
});
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_howler__ = __webpack_require__(5);
...
class Game {
  constructor(track, ctx, bpm, beatMap) {
    ...
    this.hitEffect = new __WEBPACK_IMPORTED_MODULE_0_howler__["Howl"]({
  ...
  bindKeyHandlers() {
    ...
    key("m", () => {this.hitEffect.play();
      this.track.addHitBox(this.ctx, 5);});
    key(",", () => {this.hitEffect.play();
      this.track.addHitBox(this.ctx, 6);});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__hitbox_js__ = __webpack_require__(4);
...
class Track {
  ...
  addNote(key) {
    switch(key) {
      case "a":
        this.note1.push(new __WEBPACK_IMPORTED_MODULE_0__note_js__["a" /* default */]({pos: [15,0], value: 1, game: this}));
        break;
      case "s":
        this.note2.push(new __WEBPACK_IMPORTED_MODULE_0__note_js__["a" /* default */]({pos: [95,0], value: 2, game: this}));
        break;
      case "d":
        this.note3.push(new __WEBPACK_IMPORTED_MODULE_0__note_js__["a" /* default */]({pos: [185,0], value: 3, game: this}));
        break;
      case "j":
        this.note4.push(new __WEBPACK_IMPORTED_MODULE_0__note_js__["a" /* default */]({pos: [255,0], value: 4, game: this}));
        break;
      case "k":
        this.note5.push(new __WEBPACK_IMPORTED_MODULE_0__note_js__["a" /* default */]({pos: [335,0], value: 5, game: this}));
        break;
      case "l":
        this.note6.push(new __WEBPACK_IMPORTED_MODULE_0__note_js__["a" /* default */]({pos: [415,0], value: 6, game: this}));
        break;
    }
  }

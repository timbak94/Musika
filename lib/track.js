...
class Track {
  ...
  addNote(key) {
    switch(key) {
      case "a":
        this.note1.push(new Note({pos: [15,0], value: 1, game: this}));
        break;
      case "s":
        this.note2.push(new Note({pos: [95,0], value: 2, game: this}));
        break;
      case "d":
        this.note3.push(new Note({pos: [185,0], value: 3, game: this}));
        break;
      case "j":
        this.note4.push(new Note({pos: [255,0], value: 4, game: this}));
        break;
      case "k":
        this.note5.push(new Note({pos: [335,0], value: 5, game: this}));
        break;
      case "l":
        this.note6.push(new Note({pos: [415,0], value: 6, game: this}));
        break;
    }
  }
